                        ...
                        <div class="col-lg-12 clearfix">
                            <div class="address wow fadeInLeft clearfix" data-wow-duration="500ms" data-wow-delay=".3s">
                                 ...
                                 <div class="col-lg-10" style="text-align: left; padding-top:10px;">
                                    ...
                                    <h5>Telephone: +01 630-886 7621</h5>
                        ...
                        <div class="col-lg-12 clearfix">
                            <div class="address wow fadeInLeft clearfix" data-wow-duration="500ms" data-wow-delay=".3s">
                                 ...
                                 <div class="col-lg-10" style="text-align: left; padding-top:10px;">
                                    <h3>Pittsburgh PA</h3>
                                    <h4>Alan Krohe</h4>
                                    <h5>163 Pinehurst Drive, Cranberry Township, PA 16066, USA</h5> 
                                    <h5>Telephone: +01 724-272 1916</h5>
                                    <h5>Email: Johnf@marquismetal.com</h5>
                                    <!-- <h5>Telephone: +01  </h5> -->
                                 </div>
                            </div>
                        </div>
                        <div class="col-lg-12 clearfix">
                            <div class="address wow fadeInLeft clearfix" data-wow-duration="500ms" data-wow-delay=".3s">
                                 ...
                                 <div class="col-lg-10" style="text-align: left; padding-top:10px;">
                                    <h3>Conway SC</h3>
                                    <h4>John Franken</h4>
                                    <h5>422 Briarwood Lane, Conway SC 29526, USA</h5> 
                                    <h5>Telephone: +01 843-455 6328</h5>
                                    <h5>Email: AlanK@marquismetal.com</h5>
                                    <!-- <h5>Telephone: +01  </h5> -->
                                 </div>
                            </div>
                        </div>
